 ...
 class GUMP
{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[] = $e['msg']." <span class=\"$field_class\">$field</span>";
                    break;
                case 'validate_required' :
                    $resp[] = $e['msg']."The <span class=\"$field_class\">$field</span> field is required";
                    break;
                case 'validate_valid_email':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field is required to be a valid email address";
                    break;
                case 'validate_max_len':
                    $resp[] =  $e['msg']."The <span class=\"$field_class\">$field</span> field needs to be $param or shorter in length";
                    break;
                case 'validate_min_len':
                    $resp[] = $e['msg']."The <span class=\"$field_class\">$field</span> field needs to be $param or longer in length";
                    break;
                ...
                case 'validate_min_age':
                    $resp[] = $e['msg']."The <span class=\"$field_class\">$field</span> field needs to have an age greater than or equal to $param";
                    break;
                default:
            ...
            else
            {
                switch ($e['rule']) {
                    case 'mismatch' :
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "There is no validation rule for $field";
                        }
                        break;
                    case 'validate_required':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field is required";
                        }
                        break;
                    case 'validate_valid_email':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field is required to be a valid email address";
                        }
                        break;
                    case 'validate_max_len':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to be $param or shorter in length";
                        }
                        break;
                    case 'validate_min_len':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to be $param or longer in length";
                        }
                        break;
                    case 'validate_exact_len':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to be exactly $param characters in length";
                        }
                        break;
                    case 'validate_alpha':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field may only contain alpha characters(a-z)";
                        }
                        break;
                    case 'validate_alpha_numeric':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']=  "The $field field may only contain alpha-numeric characters";
                        }
                        break;
                    case 'validate_alpha_dash':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']="The $field field may only contain alpha characters &amp; dashes";
                        }
                        break;
                    case 'validate_numeric':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field may only contain numeric characters";
                        }
                        break;
                    case 'validate_integer':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field may only contain a numeric value";
                        }
                        break;
                    case 'validate_boolean':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field may only contain a true or false value";
                        }
                        break;
                    case 'validate_float':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field may only contain a float value";
                        }
                        break;
                    case 'validate_valid_url':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']=  "The $field field is required to be a valid URL";
                        }
                        break;
                    case 'validate_url_exists':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field URL does not exist";
                        }
                        break;
                    case 'validate_valid_ip':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to contain a valid IP address";
                        }
                        break;
                    case 'validate_valid_cc':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to contain a valid credit card number";
                        }
                        break;
                    case 'validate_valid_name':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to contain a valid human name";
                        }
                        break;
                    case 'validate_contains':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to contain one of these values: ".implode(', ', $param);
                        }
                        break;
                    case 'validate_contains_list':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to contain a value from its drop down list";
                        }
                        break;
                    case 'validate_doesnt_contain_list':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field contains a value that is not accepted";
                        }
                        break;
                    case 'validate_street_address':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']=  "The $field field needs to be a valid street address";
                        }
                        break;
                    case 'validate_date':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']=  "The $field field needs to be a valid date";
                        }
                        break;
                    case 'validate_min_numeric':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']="The $field field needs to be a numeric value, equal to, or higher than $param";
                        }
                        break;
                    case 'validate_max_numeric':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field needs to be a numeric value, equal to, or lower than $param";
                        }
                        break;
                    case 'validate_min_age':
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']=  "The $field field needs to have an age greater than or equal to $param";
                        }
                        break;
                    default:
                        ...
                        if($resp['msg']=='')
                        {
                            $resp['msg']= "The $field field is invalid";
                        }
                }
