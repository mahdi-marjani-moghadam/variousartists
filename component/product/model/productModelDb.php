    ...
    public static function getProductById($id)
    {
        ...
        $conn = dbConn::getConnection();
          $sql = "SELECT
                ...
                WHERE
                `artists_products`.`Artists_products_id` = '$id' and `artists_products`.status = 1";
          ...
          $sql = "SELECT  SQL_CALC_FOUND_ROWS
                *,title_$lang as title,brif_description_$lang as brif_description,description_$lang as description
                FROM
                    artists_products
                WHERE
                    status =1 and artists_id ='$id'   ".$fields['where'].$condition['list']['filter'].$condition['list']['order'].$condition['list']['limit'] ;
