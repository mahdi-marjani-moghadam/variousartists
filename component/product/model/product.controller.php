...
//        print_r_debug($resultOtherProducts);
        ...
        if (!isset($_SERVER['HTTP_REFERER'])) {
            ...
            $breadcrumb->reset();
            $breadcrumb->add(translate('هنرمند : ').$product->fields['artists_name'], 'artists/Detail/'.$product->fields['artists_id'].'/'.$product->fields['artists_name'], true);
        } else {
        ...
        $breadcrumb->add(translate('محصول : ').$product->fields['title']);
        $export['breadcrumb'] = $breadcrumb->trail();
