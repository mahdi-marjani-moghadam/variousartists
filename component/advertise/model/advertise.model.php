...
class advertiseModel
{
    ...
    {
        include_once(dirname(__FILE__)."/advertise.model.db.php");

        $result=advertiseModelDb::getAdvertiseById($id);
    ...
    public function getAdvertise($fields)
    {
        ...
        $result=advertiseModelDb::getAdvertise($fields);
