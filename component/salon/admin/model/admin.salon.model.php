...
class adminSalonModel extends looeic
{
    ...
    public function getSalonById($id)
    {
        ...
        $result = adminSalonModelDb::getSalonById($id);
    ...
    public function getSalonByParentId($id)
    {
        ...
        $result = adminSalonModelDb::getSalonByParentId($id);
    ...
    public function convert($_input,$temp,$space='-')
    {
        ...
        foreach ($_input as $key => $val) {
            ...
            $mainMenu[$val['Salon_id']]=$val;
            $mainMenu[$val['Salon_id']]['export'] = $temp .$space.$val["title_$lang"];
            ...
            if (isset($this->list[$val['Salon_id']])) {

                $this->convert($this->list[$val['Salon_id']], $temp,$space);
            }
            $this->level--;
            $len=strlen($space);
    ...
    function getulli($array,$root=0,$all)
    {
        ...
        foreach ($array as $key => $val) {
            ...
            if(is_array($mainList[$val['Salon_id']]))
            {
                ...
                $this->getulli($mainList[$val['Salon_id']]);
                $mainMenu .= "</li>\n";
                //$list_open = false;
    ...
    public function add()
    {
        ...
        include_once(dirname(__FILE__) . "/admin.salon.model.db.php");
        $result = adminSalonModelDb::insert($this->fields);
        $this->fields['Salon_id'] = $result['export']['insert_id'];
        return $result;
    }
    ...
    public function edit()
    {
        ...
        include_once(dirname(__FILE__) . "/admin.salon.model.db.php");
        $result = adminSalonModelDb::update($this->fields);
        return $result;
    }
    ...
    {
        include_once(dirname(__FILE__) . "/admin.salon.model.db.php");
        $result=$this->getSalonByParentId($this->fields['Salon_id']);
        ...
        $result=adminSalonModelDb::delete($this->fields);
