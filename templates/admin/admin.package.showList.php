  ...
  <div id="panel-1" class="panel panel-default border-blue">
    ...
    <div class="panel-body">
      <div class="pull-right">
        <a href="<?php echo  RELA_DIR ?>zamin/?component=package&action=addPackage" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i>افزودن محصول جدید </a>
      </div>
          ...
          if (isset($list['list']))
          {
            foreach ($list['list'] as $id => $fields)
            {
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo  RELA_DIR ?>zamin/?component=package&action=editPackage&id=<?php echo $fields['Package_id']; ?>">ویرایش</a>
                  <a href="<?php echo  RELA_DIR ?>zamin/?component=package&action=deletePackage&id=<?php echo $fields['Package_id']; ?>">حذف</a>
                </td>
