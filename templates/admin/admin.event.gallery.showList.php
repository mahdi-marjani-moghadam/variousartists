...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        var oTable = dataTable.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>admin/?component=event&action=searchGallery&status=<?=$list['status']?>&event_id=<?=$_GET['id']?>",
            "ordering": false
        });
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        ...
        <div class="panel-body">
            <div class="pull-right"><a href="<?= RELA_DIR ?>admin/?component=event&action=addGallery&event_id=<?=$_GET['id']?>"
