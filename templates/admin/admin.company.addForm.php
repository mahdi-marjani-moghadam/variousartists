                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <select name="state_id" id="province_id" data-input="select2">
                                            ...
                                            {?>
                                            <option
                                                <?php echo  $value['province_id'] == $list['province_id'] ? 'selected' : '' ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <input type="text" class="form-control date" name="refresh_date" id="refresh_date" value="<?php echo  $list['refresh_date'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <select name="company_phone[state][]" class="select-phone-state">
                                                <option value="1" <?php echo  ($list['company_phone']['state'][$i]) == 1 ? 'selected' : '' ?>>داخلی</option>
                                                <option value="2" <?php echo  ($list['company_phone']['state'][$i]) == 2 ? 'selected' : '' ?>>الی</option>
                                                <option value="3" <?php echo  ($list['company_phone']['state'][$i]) == 3 ? 'selected' : '' ?>>سایر</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8 pull-right">
                                            <input type="text" class="form-control" name="company_email[subject][]" id="email_subject" value="<?php echo  $list['company_email']['subject'][$i] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9 pull-right">
                                            <input type="email" class="form-control" id="email_email" name="company_email[email][]" value="<?php echo  $list['company_email']['email'][$i] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-1">
