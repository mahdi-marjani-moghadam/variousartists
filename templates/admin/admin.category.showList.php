    ...
    <div id="panel-1" class="panel panel-default border-blue">
        ...
        <div class="panel-body">
            <div class="pull-right">
                <a href="<?php echo  RELA_DIR ?>zamin/?component=category&action=add" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i> افزودن دسته بندی جدید</a>
            </div>
            <!-- separator -->
                ...
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo  RELA_DIR ?>zamin/?component=category&action=edit&id=<?php echo $fields['Category_id']; ?>">ویرایش</a>
                                <a href="<?php echo  RELA_DIR ?>zamin/?component=category&action=delete&id=<?php echo $fields['Category_id']; ?>">حذف</a>
                            </td>
                        </tr>
                    <?php
                    }
