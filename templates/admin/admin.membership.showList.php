<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        var oTable = dataTable.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?=RELA_DIR?>zamin/?component=membership&action=search&status=<?=$list['status']?>",
            "ordering": false
        });
...
<div class="content-control">
    ...
    <ul class="control-nav pull-right">
        <li><a class="rtl text-24"><i class="sidebar-icon fa fa-adn"></i> لیست اعضا</a></li>
    </ul>
    <!--/control-nav-->
</div>
<!-- /content-control -->
...
<div class="content-body">
    ...
    <div id="panel-1" class="panel panel-default border-blue">
        ...
        <div class="panel-body">
            <div class="pull-right" ><a href="<?= RELA_DIR ?>zamin/?component=membership&action=add"
            ...
            <div class="table-responsive table-responsive-datatables">
                <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0"
                    ...
                    <th><select name="search_5" class="search_init " id="search_9">
