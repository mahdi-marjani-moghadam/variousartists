                    ...
                    <form name="queue" id="queue" role="form" data-validate="form" class="form-horizontal form-bordered"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="city_id" id="city_id" data-input="select2">
                                            ...
                                            {
                                                ?>
                                                <option <?= $value['City_id'] == $list['city_id'] ? 'selected' : '' ?>
                                                    value="<?= $value['City_id'] ?>">
                                                    <?= $value['name'] ?>
                                                </option>
                                                <?
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 pull-right">
                                        <select name="state_id" id="state_id" data-input="select2">
                                            ...
                                            {?>
                                                <option
                                                    <?= $value['State_id'] == $list['state_id'] ? 'selected' : '' ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <select name="priority" id="priority">
                                            <option value="1" <?= ($list['priority'] == '1') ? 'selected="selected"' : ''; ?>>1
                                            </option>
                                            <option value="0" <?= ($list['priority'] == '0') ? 'selected="selected"' : ''; ?>>0
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        <div class="input-group" dir="ltr">
                                            <input name="logo" type="text" class="form-control" id="xImagePath" value="<?= $list['logo']; ?>"/>
                        ...
                        <div id="phone-container">
                            <?php foreach($list['company_phone']['subject'] as $i => $value) { ?>
                                <input type="hidden" name="company_phone[Company_phones_id][]" value="<?= $list['company_phone']['Company_phones_id'][$i] ?>">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-8 pull-right">
                                                <select name="company_phone[state][]" class="select-phone-state">
                                                    <option value="داخلی" <?= ($list['company_phone']['state'][$i]) == 'داخلی' ? 'selected' : '' ?>>داخلی</option>
                                                    <option value="الی" <?= ($list['company_phone']['state'][$i]) == 'الی' ? 'selected' : '' ?>>الی</option>
                                                    <option value="سایر" <?= ($list['company_phone']['state'][$i]) == 'سایر' ? 'selected' : '' ?>>سایر</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="email-container">
                            <?php foreach($list['company_email']['subject'] as $i => $value) { ?>
                                <input type="hidden" name="company_email[Company_emails_id][]" value="<?= $list['company_email']['Company_emails_id'][$i] ?>">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                                            ...
                                            <div class="col-xs-12 col-sm-8 pull-right">
                                                <input type="text" class="form-control" name="company_email[subject][]"
                                                       id="email_subject" value="<?= $list['company_email']['subject'][$i] ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-9 pull-right">
                                                <input type="email" class="form-control" id="email_email"
                                                       name="company_email[email][]" value="<?= $list['company_email']['email'][$i] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-1">
                        ...
                        <div id="address-container">
                            <?php foreach($list['company_address']['subject'] as $i => $value) { ?>
                                <input type="hidden" name="company_address[Company_addresses_id][]" value="<?= $list['company_address']['Company_addresses_id'][$i] ?>">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
                        ...
                        <div id="website-container">
                            <?php foreach($list['company_website']['subject'] as $i => $value) { ?>
                                <input type="hidden" name="company_website[Company_websites_id][]" value="<?= $list['company_website']['Company_websites_id'][$i] ?>">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-4 pull-right control-label rtl"
