  ...
  <div id="panel-1" class="panel panel-default border-blue">
    ...
    <div class="panel-body">
        <div class="pull-right">
            <a href="<?php echo RELA_DIR?>zamin/?component=certification&action=add" class="btn btn-primary btn-sm btn-icon text-13"><i class="fa fa-plus"></i> افزودن گواهی جدید</a>
        </div>
        <!-- separator -->
            ...
            <table id="example" class="companyTable table table-striped table-bordered rtl" cellspacing="0" width="100%">
              ...
              {?>
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo RELA_DIR?>zamin/?component=certification&action=edit&id=<?php echo $fields['Certification_id'];?>">ویرایش</a> <br/>
                        <a href="<?php echo RELA_DIR?>zamin/?component=certification&action=delete&id=<?php echo $fields['Certification_id'];?>">حذف</a>
                    </td>
                  </tr>
              <?php
