<section id="page-title">
    ...
    <div class="container clearfix">
        <h1> Contact with <span>Various Artists</span></h1>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12  pull-right">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control  transition ltr" required data-error="لطفا نام خود را وارد نمایید" placeholder="Name" value="<?php echo (isset($list) && strlen($list['list']['name']) ? $list['list']['name'] : ""); ?>" tabindex="1">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
