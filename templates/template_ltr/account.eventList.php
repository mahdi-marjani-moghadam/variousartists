                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" style="overflow: scroll">
                                        <table   class="table table-responsive table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo RELA_DIR?>invoice/<?php echo $list['list']["artists_name_$lang"]?>/<?php echo $value['Artists_invoices_id']?>/<?php echo $value['title']?>"><?php echo $value['title']?></a></td>

                                                <td><?php echo $value['date']?></td>
                                                <td>
                                                    <div class="style-msg   <?php echo ($value['status'] == 1)?'':'style-msg-light';?>" style="background-color: <?php echo ($value['status'] == 1)?'#EEE':'#444';?>">
                                                        <div class="sb-msg"><i class="<?php echo ($value['status'] == 1)?'icon-thumbs-up':'icon-remove';?>"></i>  <?php echo ($value['status'] == 1)?'Confirm':'Cancel';?></div>
                                                    </div>
                                                    <a href="<?php echo RELA_DIR?>account/editEvent/<?php echo $value['Event_id']?>" class="button button-3d button-dirtygreen" >Edit</a>
                                                </td>
