...
<section id="page-title" >
    ...
    <div class="container clearfix">
        <h1> Search : `<?php echo $_REQUEST['q']?>` From `<?php echo $_REQUEST['type']?>` </h1>
                        ...
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay">
                                <div class="portfolio-desc">
                                    ...
                                    <h3><a href="<?php echo RELA_DIR . 'event/Detail/' . $value['Events_id'] . '/' . $value["event_name_$lang"]; ?>"><?php echo($value["event_name_$lang"] != "" ? $value["event_name_$lang"] : "-"); ?> </a></h3>
                                    <!--<span><a href="#">Media</a>, <a href="#">Icons</a></span>-->
                                </div>
                                <a href="<?php echo (strlen($value['logo']) ? RELA_DIR.'statics/event/'.$value['logo'] : RELA_DIR.'templates/'.CURRENT_SKIN.'/assets/images/placeholder.png'); ?>" class="left-icon" data-lightbox="image"><i
                                            class="icon-line-zoom-in"></i></a>
                                <a href="<?php echo RELA_DIR . 'event/Detail/' . $value['Event_id'] . '/' . $value["event_name_$lang"]; ?>" class="right-icon"><i title="جزییات" class="icon-line-ellipsis"></i></a>
                            </div>
                        </div>
                    </article>
