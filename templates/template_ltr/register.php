                        ...
                        <div class="panel panel-default nobottommargin">
                            <div class="panel-body" style="padding: 10px;">
                                ...
                                <form id="register-form" name="register-form" enctype="multipart/form-data" class="nobottommargin" action="<?=RELA_DIR?>register" method="post">
                                    ...
                                    <div class="col_full">
                                        <label for="check1"><input <? if($_REQUEST['check1'] == 'on'){echo 'checked';}?> type="checkbox" id="check1" name="check1"/><?=are_you_artists_please_click_here?></label>
                                    </div>
                                    ...
                                    <div class="col_full nobottommargin">
                                        ...
                                        <a class="pull-right" href="<?=RELA_DIR?>login"><?=login_by_account?></a>
                                    </div>
