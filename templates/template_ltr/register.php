                                ...
                                <form id="register-form" name="register-form" enctype="multipart/form-data" class="nobottommargin" action="<?php echo RELA_DIR ?>register" method="post">
                                    ...
                                    <div class="col_full form-group">
                                        ...
                                        <div class="input-group jail center">
                                            ...
                                            <input style="box-shadow: none" type="tel" <?php if ($list['default'][0]['iso'] == 'IR') { ?>maxlength="<?php echo $list['default'][0]['max_length'] ?>" <?php } ?> class="phone form-control" id="artists_phone1" name="artists_phone1" placeholder="<?php echo $list['default'][0]['sample'] ?>" required value="<?php echo $_REQUEST['artists_phone1'] ?>">
                                    ...
                                    <div class="col_full">
                                        <label for="artists_name_fa"><?php echo name_en ?> <span class="red-text">*</span></label>
                                    ...
                                    <div class="col_full art">
                                        <label for="artists_name_en"><?php echo name_fa ?> <span class="red-text">*</span></label>
                                    ...
                                    <div class="col_full" style="display: none">
                                        <label for="city_id">born place:</label>
