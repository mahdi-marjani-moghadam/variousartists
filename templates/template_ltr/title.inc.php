				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" class="dark style-6 style-2">
						...
						<ul>
							...
							<li class="<?php echo ($PARAM[0] == 'artists')?'current':'';?>"><a href="<?php echo RELA_DIR?>blog"><div>Blog</div></a></li>
							...
							<?php }  ?>
                            <li ><a href="<?php echo RELA_DIR?>index/?lang=fa"><div><img src="<?php echo RELA_DIR?>templates/<?php echo CURRENT_SKIN?>/img/flag_fa.png">فارسی </div></a></li>
						</ul>
