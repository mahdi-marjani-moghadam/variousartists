        ...
        <div class="container clearfix">
            ...
            <div class="col artists_img nobottommargin text-center" >
                ...
                <div class="si-share clearfix no-border mt-1  ">
                    <div class="pull-left">Follow <?php echo $list['list']['artists_name'];?> social network:</div>
                    <div class="">
                ...
                <div class="fancy-title title-bottom-border topmargin-sm">
                    ...
                    <ul class="portfolio-meta bottommargin">
                        <?php if($list['list']['show_birthday'] == 'on'):?>
                            <div class="line"></div>
                            <li><span><i class="icon-user"></i><?php echo birthday?></span><?php echo ($list['list']['birthday'])?></li>
                        <?php endif; ?>
