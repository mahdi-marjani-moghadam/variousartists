...
<div id="page-menu">
    ...
    <div id="page-menu-wrap">
        ...
        <div class="container clearfix">
            ...
            <div class="menu-title">تماس با <span>VA</span></div>
        ...
        <div class="container clearfix">
            ...
            <div class="col-md-6 bottommargin">
                ...
                <form class="" action="" method="post" name="form1" id="form1" role="form" novalidate="novalidate" data-toggle="validator">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12  pull-right" style="background: rgba(255,255,255,0.1); padding-bottom: 20px; padding-top: 20px">
            ...
            <div class="col-md-6">
                ...
                <div class="col_two_fifth">
                    ...
                    <address>
                        ...
                        تهران میدان تجریش خیابان ولیعصر <br>
                        خیابان زعفرانیه کوچه اول پلاک ۳<br>

                    </address>
                    <abbr title="Phone Number"><strong>موبایل:</strong></abbr><span dir="ltr"> (91) 8547 632521</span><br>
                    <abbr title="Fax"><strong>فکس:</strong></abbr><span dir="ltr"> (91) 11 4752 1433</span><br>
                    <abbr title="Email Address"><strong>ایمیل:</strong></abbr><span dir="ltr"> info@canvas.com</span>
