        ...
        <section class="section">
            <div class="container">
                <div class="col-md-12 text-center" >
                    <h1 >سایت معرفی هنرمندان</h1>
                    <p>مجموعه ی VariousArtists.ir (( سوشیال نتورک )) مرجعی تخصصی در حوزه ی موسیقی است که به معرفی هنرمندان ایرانی خارج و داخل کشور ، و همچنین اطلاع رسانی جامع در مورد رویدادهای موسیقی ایرانی , می پردازد .</p>
                </div>
            </div>
        </section>
        <section>
