                    ...
                    <div class="tab-content clearfix" id="tab-login" style="background: rgba(255,255,255,0.2)">
                        <div class="panel panel-default nobottommargin">
                            <div class="panel-body" style="padding: 40px;">
                                ...
                                <div id="alertMessage"><div class="alert alert-danger rtl"><?php echo $msg?></div></div>
                                <?php endif;?>
                                ...
                                <input type="hidden"  name="action" value="login">
                                    ...
                                    <div class="col_full nobottommargin">
                                        ...
                                        <div class="text-center col-xs-12">
                                            <a  class="" style="" data-toggle="modal" data-target=".bs-example-modal-sm"><?php echo forgot_password?></a>
                                        </div>
                                        <!-- Small modal -->
