                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 pull-right">
                            <select class="form-control" name="category_id[]" data-input="select2" placeholder="Multiple select" multiple>
                                ...
                                ?>
                                    <option <?php echo isset($list['category_id']) && in_array($category_id, $list['category_id']) ? 'selected' : '' ?> value="<?php echo $category_id ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 pull-right">
                            <select class="form-control" name="genre_id[]" data-input="select2" multiple>
                                ...
                                ?>
                                    <option <?php echo isset($list['genre_id']) && in_array($genre_id, $list['genre_id']) ? 'selected' : '' ?> value="<?php echo $genre_id ?>">
                                        <?php echo $value['export'] ?>
                                    </option>
                                <?php
                                }
