                ...
                <?$newDate = ($list['list']['date']!="0000-00-00" ? convertDate($list['event_time']):"");?>
                    <div class="panel panel-default events-meta" id="changeNumber">
                        <div class="panel-heading">
                            <h3 class="panel-title">رویداد:<?php echo $list['event_name']?></h3>
                        </div>
...
<br>
                                    <br><br>
                                    <li><i class="icon-map-marker2"></i> محل برگزاری:    <?php echo $list['place_name']?></li>
                                    <br>
                                    <li><i class="icon-paperplane"></i> بخش انتخابی:   <?php echo $list['part_name']?></li>
                                    <br>
