                                        ...
                                        <table   class="table table-responsive table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?=RELA_DIR?>account/editBlog/<?=$value['id']?>" class="button button-3d button-dirtygreen" >ویرایش</a>
                                                    <a href="<?=RELA_DIR?>account/deleteBlog/<?=$value['id']?>" class="button button-3d button-red" >حذف</a>
