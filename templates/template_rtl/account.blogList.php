                                        ...
                                        <table   class="table table-responsive table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo RELA_DIR?>account/editBlog/<?php echo $value['id']?>" class="button button-3d button-dirtygreen" >ویرایش</a>
                                                    <a href="<?php echo RELA_DIR?>account/deleteBlog/<?php echo $value['id']?>" class="button button-3d button-red" >حذف</a>
