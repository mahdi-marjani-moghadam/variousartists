            ...
            <div class="row">
                ...
                <?php if ($member_info['type'] == 1) : ?>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <input type="<?php echo  ($lang == 'en') ? 'date' : ''; ?>" id="birthday" name="birthday" value="<?php echo  convertDate($list['birthday']) ?>" class="form-control <?php echo  ($lang == 'en') ? '' : 'datepicker'; ?>" />
                    </div>
                ...
                <?php if ($member_info['type'] == 1) : ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="description_fa"><?php echo  description_fa ?></label>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="description_en"><?php echo  description_en ?></label>
                            <div class="col-xs-12 col-sm-8 pull-right">
                                <?php
